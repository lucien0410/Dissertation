...
n<- subset(n, select=c("Round", "Gaelic", "ConcatGLOSSGaelic"))
gd<-n['Gaelic'][1:10,1]
Treatment<-n['ConcatGLOSSGaelic'][1:10,1]  # [11,1] is MEAN
...
xtab<-xtable(n, caption="BLEU scores of Model\\textsubscript{GDtoEN}Model\\ and textsubscript{ConcatGLOSSGaelictoEn} ",  label="Table:Concating", align="llcc")
names(xtab)<-c('Round', 'Gaelic (Baseline)', 'ConcatGLOSSGaelic' )

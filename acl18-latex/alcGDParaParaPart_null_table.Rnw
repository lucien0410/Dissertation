...
n<- subset(n, select=c("Round", "Gaelic", "ParaReal","ParaPart"))
gd<-n['ParaReal'][1:10,1]
...
xtab<-xtable(n, caption="BLEU scores of Model\\textsubscript{GDtoEN} and Model\\textsubscript{ConcatGLOSSGaelictoEn} ",  label="Table:Concating", align="llccc")

...
xtab<-xtable(n, caption="BLEU scores of Model\\textsubscript{GDtoEN} and Model\\textsubscript{ReplacingGaelictoEn}",  label="Table:ReplacingGaelic", align="llcc")
names(xtab)<-c('Round', 'Gaelic (Baseline)', 'ReplacingGaelic' )
